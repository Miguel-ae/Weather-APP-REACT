          ...
          <div className="card mb-3 mx-auto bg-dark text-light">
            <div className="row g-0">
              <div className="col-md-4">
                ...
                <img
                  className="img-size rounded-start"
                  src="https://images.pexels.com/photos/18534197/pexels-photo-18534197/free-photo-of-punto-de-referencia-textura-abstracto-resumen.jpeg?"
                  alt="..."
                />
              </div>
